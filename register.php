...
<body>
  ...
  <br><br><br>  <div class="container">
        <h2> <b>You successfully registered in our E-Store website .<br><br>thank you for join our E-Store </b></h2><hr>
        <h2>Enjoy our Service<a button type="button" href="#"  data-target="#mymodal" data-toggle="modal"> <b><u>click here</u></b>  </a>to Login and Enjoy shopping</h2>
    </div>
    <?php
    include("login.php");
