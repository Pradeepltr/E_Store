...
<body>
  ...
  <br><br><br>  <div class="container">
        <h2> <b>Invalid Username/email and Password .<br><br>Please provide correct email and password to successful Login </b></h2><hr>
        <h2><a button type="button" href="#"  data-target="#mymodal" data-toggle="modal"> <b><u>click here</u></b>  </a>to Login and Enjoy shopping</h2>
    </div>
    <?php
    include("login.php");
